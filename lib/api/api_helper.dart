...
class Api {
  ...
  static Future<void> createUser() async {
    ...
    final chatUser = ChatUserModel(
        ...
        About: "Hey,I'm using hello Chat App",
        CreatedAt: time,
        IsOnline: false,
        LastActive: time,
...
//update profile picture of user
  ...
  //for getting all users from firebase databae
  ...
  static Future<void> sendMessage(ChatUserModel chatUser, String msg) async {
    ...
    //message to send
    final MessageModel message = MessageModel(fromId: user.uid,
        msg: msg,
        type: Type.text,
        toId: chatUser.Id,
        sent: time,
